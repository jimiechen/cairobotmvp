...
- Object: CaiRobot.ProviderAdminServer.ProviderAdminObj
- Module: CaiRobotProviderAdminApp
- Interface: ProviderAdminObj
- IDL: tars/protocol/tars/provider_admin.tars
