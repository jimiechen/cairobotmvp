...
设备网关服务，提供设备命令下发、状态查询、心跳、事件上报等设备通信能力。
...
- Object: CaiRobot.DeviceGatewayServer.DeviceGatewayObj
- Module: CaiRobotDeviceGatewayApp
- Interface: DeviceGatewayObj
- IDL: tars/protocol/tars/device_gateway.tars
